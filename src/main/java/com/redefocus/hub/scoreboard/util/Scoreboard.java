package com.redefocus.hub.scoreboard.util;
...
public class Scoreboard {
    ...
    /**
     * Create PermissionsManager scoreboard sign for PermissionsManager given player and using PermissionsManager specifig objective name
     *
    ...
    /**
     * Change PermissionsManager scoreboard line and send the packets to the player. Can be called async.
     *
    ...
    /**
     * Remove PermissionsManager given scoreboard line
     *
    ...
    /**
     * Get the current value for PermissionsManager line
     *
     * @param line the line
    ...
    /**
     * Get the team assigned to PermissionsManager line
     *
    ...
    private PlayerConnection getPlayer() {
        ...
        return craftPlayer.getHandle().playerConnection;
    }
    ...
    /**
     * This class is used to manage the content of PermissionsManager line. Advanced users can use it as they want, but they are encouraged to read and understand the
